    ...
    try {
      ...
      snapshot.forEach((docSnap) => {
        ...
        loadedUsers.push({
          ...
          activePlanId: isSuper ? 'plan_titan_naira' : ((!isSuper && isSubscriptionExpired(data)) ? '' : (data.activePlanId || '')),
          membershipTier: isSuper ? 'Grobaax Titan Annual VIP' : ((!isSuper && isSubscriptionExpired(data)) ? 'Free Scholar' : (data.membershipTier || data.subscriptionTier || 'Free Scholar')),
          subscriptionTier: isSuper ? 'Grobaax Titan Annual VIP' : ((!isSuper && isSubscriptionExpired(data)) ? 'Free Scholar' : (data.subscriptionTier || data.membershipTier || 'Free Scholar')),
          subscriptionPlan: isSuper ? 'Grobaax Titan Annual VIP' : ((!isSuper && isSubscriptionExpired(data)) ? 'Free Scholar' : (data.subscriptionPlan || data.membershipTier || '')),
          planId: isSuper ? 'plan_titan_naira' : ((!isSuper && isSubscriptionExpired(data)) ? '' : (data.planId || data.activePlanId || '')),
          tier: isSuper ? 'Grobaax Titan Annual VIP' : ((!isSuper && isSubscriptionExpired(data)) ? 'Free Scholar' : (data.tier || data.membershipTier || 'Free Scholar')),
          plan: isSuper ? 'Grobaax Titan Annual VIP' : ((!isSuper && isSubscriptionExpired(data)) ? 'Free Scholar' : (data.plan || '')),
          targetTier: isSuper ? 'vip' : ((!isSuper && isSubscriptionExpired(data)) ? 'free' : (data.targetTier || data.tierType || 'free')),
          tierType: isSuper ? 'vip' : ((!isSuper && isSubscriptionExpired(data)) ? 'free' : (data.tierType || data.targetTier || 'free')),
          isSubscribed: isSuper || (!(!isSuper && isSubscriptionExpired(data)) && Boolean(data.isSubscribed || data.isPremium || (data.activePlanId && !data.activePlanId.toLowerCase().includes('free')))),
          isPremium: isSuper || (!(!isSuper && isSubscriptionExpired(data)) && Boolean(data.isPremium || (data.activePlanId && !data.activePlanId.toLowerCase().includes('free')))),
          isVip: isSuper || (!(!isSuper && isSubscriptionExpired(data)) && Boolean(data.isVip || (data.membershipTier && data.membershipTier.toLowerCase().includes('vip')))),
